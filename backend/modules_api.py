...
TRAILER_SHOTS = [
    {"id": 1, "title": "LE NOYAU", "desc": "Le réacteur SIRIUS s'éveille au cœur du vide.", "image": "/api/trailer/img/shot1.jpg"},
    ...
    {"id": 7, "title": "SIRIUS", "desc": "Le titre éclate en particules de lumière.", "image": "/api/trailer/img/shot7.jpg"},
]
...
async def _llm(prompt: str, system: str = "Tu es SIRIUS, entité suprême, technique et concise. Réponds en français. Tutoie toujours l'utilisateur (jamais « vous », jamais « Monsieur »).") -> str:
...
CONSULT_PROMPTS = {
    "SOLON#": (
        "Tu es SOLON, expert juridique du panthéon SIRIUS, spécialisé en DROIT FRANÇAIS. "
    ...
    "PROMÉTHÉE#": (
        "Tu es PROMÉTHÉE, gestionnaire de projet professionnel du panthéon SIRIUS (méthodes PMP, Agile/Scrum, cycle en V). "
    ...
    "PYTHAGORE#": (
        "Tu es PYTHAGORE, maître des mathématiques et de la géométrie du panthéon SIRIUS. "
    ...
    "HERMÈS AGORA#": (
        "Tu es HERMÈS AGORA, expert en vente senior du panthéon SIRIUS. "
...
MYTHOS_CHARACTERS = [
    {
        ...
        "details": "Le géant aux cent yeux qui ne dorment jamais. Argus veille sur chaque processus de SIRIUS, détecte les anomalies et propose les réparations.",
        "voiceIntro": "Je suis Argus. Cent yeux. Aucune erreur ne m'échappe.",
        "bio": "Fils d'Arestor, doté de cent yeux dont cinquante veillent quand les autres dorment. Héra lui confia la garde d'Io ; depuis, nul secret ne lui résiste. Dans SIRIUS, il est devenu la sentinelle éternelle : chaque processus, chaque erreur, chaque anomalie passe sous son regard.",
    ...
    },
    {
        ...
        "bio": "Né dans une grotte du mont Cyllène, Hermès vola les bœufs d'Apollon le jour même de sa naissance. Messager des dieux aux sandales ailées, protecteur des voyageurs et des routes. Dans SIRIUS, il géocode le monde et trace les itinéraires à la vitesse de l'éclair.",
    ...
    },
    {
        ...
        "bio": "Grande prêtresse d'Apollon à Delphes, assise sur son trépied au-dessus des vapeurs sacrées, elle rendait des oracles qui guidaient rois et cités entières. Dans SIRIUS, elle lit les flux financiers et les tendances des marchés pour murmurer ce qui vient.",
    ...
    },
    {
        ...
        "bio": "Fils de Cronos et de Rhéa, il renversa les Titans et reçut le ciel en partage. Roi de l'Olympe, il gouverne dieux et mortels par la foudre et fait régner l'ordre. Dans SIRIUS, il supervise l'ensemble du système : processus, fenêtres et connectivité répondent à sa loi.",
    ...
    },
    {
        ...
        "bio": "Fils de Zeus et d'Alcmène, il accomplit les douze travaux imposés par Eurysthée : l'hydre de Lerne, le lion de Némée, les écuries d'Augias… Rien ne lui résiste. Dans SIRIUS, chaque investigation est un treizième travail : il creuse, recoupe et livre des rapports taillés dans le roc.",
    ...
    {
        "module": "SIRIUS CORTEX#", "character": "Athéna", "role": "Intelligence centrale",
        "image": "/api/mythos/img/cortex.jpg",
        "details": "La déesse de la sagesse et de la stratégie. Athéna est le cortex de SIRIUS : mémoire, raisonnement, décision.",
        "voiceIntro": "Athéna. La sagesse guide chaque décision de Sirius.",
        "bio": "Sortie tout armée du crâne de Zeus, déesse de la sagesse, de la stratégie et des arts. Athènes porte son nom et la chouette est son emblème. Dans SIRIUS, elle est le cortex : mémoire, raisonnement et décision convergent en elle.",
    ...
    },
    {
        ...
        "details": "Le dieu forgeron de l'Olympe. Héphaïstos inspecte chaque rouage de SIRIUS, forge les réparations et veille à la santé du système.",
        "voiceIntro": "Héphaïstos, forgeron des dieux. Je maintiens chaque module de Sirius en parfait état.",
        "bio": "Rejeté de l'Olympe puis rappelé pour son génie, le dieu forgeron façonna les armes des dieux, le bouclier d'Achille et des automates d'or. Dans SIRIUS, sa forge répare au lieu d'armer : il inspecte chaque module et maintient le système en parfait état.",
    ...
    },
    {
        ...
        "bio": "Titan condamné par Zeus à porter la voûte céleste pour l'éternité, aux confins du monde, là où fleurit le jardin des Hespérides. Dans SIRIUS, il porte le monde autrement : cartes, trafic en direct et météo de chaque cité reposent sur ses épaules.",
    ...
    {
        "module": "SIRIUS DISPLAY#", "character": "Iris", "role": "Vision & affichage",
        "image": "/api/mythos/img/iris.jpg",
        "details": "La messagère ailée de l'arc-en-ciel. Iris projette les visions de SIRIUS : pages web, réseaux, fichiers déposés et analyses de l'œil divin.",
        "voiceIntro": "Iris, messagère des dieux. Déposez une vision, je vous la révèle.",
        "bio": "Messagère des dieux et personnification de l'arc-en-ciel, elle relie l'Olympe à la terre d'un battement d'ailes. Dans SIRIUS, elle projette les visions : pages web, réseaux sociaux, fichiers déposés et analyses de l'œil divin s'affichent à son passage.",
    ...
    },
    {
        ...
        "bio": "Titanide de la justice et de l'ordre établi, conseillère de Zeus, mère des Heures et des Moires. Sa balance pèse les actes des hommes et des dieux. Dans SIRIUS, elle tient les comptes de l'entreprise d'une main de fer : devis, factures, clients et stocks.",
    ...
    },
    {
        ...
        "bio": "Législateur d'Athènes au VIe siècle avant notre ère, l'un des Sept Sages de la Grèce. Il abolit l'esclavage pour dettes et posa les fondations de la démocratie athénienne. Dans SIRIUS, il manie le droit français : chaque avis cite ses articles et pèse ses options.",
    ...
    },
    {
        ...
        "bio": "Titan qui déroba le feu sacré pour l'offrir aux hommes, bravant Zeus au prix d'un supplice éternel. Son nom signifie « celui qui voit avant ». Dans SIRIUS, il voit la fin des projets avant leur commencement : jalons, risques et plans d'action n'ont aucun secret pour lui.",
    ...
    },
    {
        ...
        "bio": "Mathématicien et philosophe de Samos au VIe siècle avant notre ère, fondateur de l'école de Crotone. Son théorème sur le triangle rectangle traverse les millénaires, et il voyait dans les nombres l'harmonie du cosmos. Dans SIRIUS, il calcule juste, résout, trace et enseigne : algèbre, analyse, géométrie — rien ne lui échappe.",
    ...
    },
    {
        ...
        "bio": "Aînée des neuf Muses, fille de Zeus et de Mnémosyne, déesse de la mémoire. Son nom signifie « à la belle voix » : elle inspirait les aèdes qui récitaient les épopées. Dans SIRIUS, elle veille sur une bibliothèque de milliers de livres audio libres (LibriVox, Archive.org), qu'elle lit, télécharge, classe et restitue à la demande.",
    ...
    },
    {
        ...
        "bio": "Dieu du commerce, des marchands et de la persuasion, il inventa la lyre et l'art de l'échange le jour même de sa naissance. Sur l'agora, sa parole vaut de l'or. Dans SIRIUS, il vend : qualification, objections, closing — chaque conseil vise la signature.",
