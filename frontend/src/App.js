...
// Détermine la requête puis demande le service (sauf préférence enregistrée)
  ...
  // Réception des tokens Spotify / de la confirmation Outlook renvoyés par leur popup respective
  useEffect(() => {
    // Les popups sont des pages HTML servies par l'API (BACKEND_BASE), pas par le SPA : leur
